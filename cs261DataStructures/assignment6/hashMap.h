...
struct hashMap
{
    hashLink ** table; /*array of pointers to hashLinks. hash table -> array of lists */
    int tableSize; /*number of buckets in the table. size of hash table itself */
    int count; /*number of hashLinks in the table. how many elements are in hash table */
};
